...
DERIVED_DATA_DIR="/private/tmp/FlickArrangeDerivedData"
BUILT_APP="$DERIVED_DATA_DIR/Build/Products/Debug/Flick.app"
INSTALLED_APP="/Applications/Flick Arrange.app"
ENTITLEMENTS="$DERIVED_DATA_DIR/Build/Intermediates.noindex/FlickArrange.build/Debug/Flick.build/Flick.app.xcent"
